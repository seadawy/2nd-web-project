<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" UnobtrusiveValidationMode="none" CodeBehind="editProduct.aspx.cs" Inherits="Eapha.Admin.editProduct" %>
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Edit Product</a></li>
            </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="forms-sample">
                        ...
                        <asp:Button ID="Button1" runat="server" class="btn btn-primary me-2" Text="Save changes" OnClick="save_Click" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="js" runat="server"></asp:Content>
